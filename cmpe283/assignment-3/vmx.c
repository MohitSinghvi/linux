...
// Assignment 3
extern u32 exit_count_input[69];
extern u64 processing_time[69];
...
static int __vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
{
	...
	if (exit_reason.basic <= 69) {
		exit_count_input[exit_reason.basic]++;
	}
	...
	//Assignment 3
	processing_time[(int)exit_handler_index] = (overallTime + processing_time[(int)exit_handler_index]);
